...
const SUA_NECESSIDADE = (
  <Contato
    ...
    description="Nos diga qual vai ser o objetivo de uso do PC e acessórios irá precisar, assim saberemos o que indicar para você!"
  />
)

export const modelsContatos: Record<string, JSX.Element[]> = {
